...
🚨 使用本SDK工具包前，请务必熟读 [企业微信 API - 第三方应用开发](https://developer.work.weixin.qq.com/document/path/90594)。
...
`provider_access_token` 是公众号API调用的必备条件，SDK包会自动获取并缓存它以供使用。如果要获取它的值，可以通过如下方式获取：

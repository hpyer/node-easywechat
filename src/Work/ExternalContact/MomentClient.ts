...
export default class MomentClient extends BaseClient
{
   ...
   * @returns
   */
  getTasks(momentId: string, cursor: string = '', limit: number = 500): Promise<any>
  {
    let params = {
      moment_id: momentId,
      cursor,
   ...
   * @returns
   */
  getCustomers(momentId: string, userId: string, cursor: string = '', limit: number = 500): Promise<any>
  {
    let params = {
      moment_id: momentId,
      userid: userId,
   ...
   * @returns
   */
  getSendResult(momentId: string, userId: string, cursor: string = '', limit: number = 3000): Promise<any>
  {
    let params = {
      moment_id: momentId,
      userid: userId,

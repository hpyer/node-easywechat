...
class Response implements ResponseInterface
{
  ...
  constructor(statusCode: number = 200, headers: Record<string, any> = {}, content: any = null, version: string = '1.1', reason: string = null)
  {
    if (!reason && this.PHRASES[statusCode] !== undefined) {
      reason = this.PHRASES[statusCode];
    }
...
applyMixins(Response, [MessageMixin]);

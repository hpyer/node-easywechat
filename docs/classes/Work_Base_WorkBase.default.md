[node-easywechat](../README.md) / [Exports](../modules.md) / [Work/Base/WorkBase](../modules/Work_Base_WorkBase.md) / default

# Class: default

[Work/Base/WorkBase](../modules/Work_Base_WorkBase.md).default
...
- [constructor](Work_Base_WorkBase.default.md#constructor)

### Properties

- [accessToken](Work_Base_WorkBase.default.md#accesstoken)
- [app](Work_Base_WorkBase.default.md#app)

### Methods

- [doRequest](Work_Base_WorkBase.default.md#dorequest)
- [getAccessToken](Work_Base_WorkBase.default.md#getaccesstoken)
- [getCallbackIp](Work_Base_WorkBase.default.md#getcallbackip)
- [httpGet](Work_Base_WorkBase.default.md#httpget)
- [httpPost](Work_Base_WorkBase.default.md#httppost)
- [httpPostJson](Work_Base_WorkBase.default.md#httppostjson)
- [httpUpload](Work_Base_WorkBase.default.md#httpupload)
- [request](Work_Base_WorkBase.default.md#request)
- [requestRaw](Work_Base_WorkBase.default.md#requestraw)
- [setAccessToken](Work_Base_WorkBase.default.md#setaccesstoken)
...
[Work/Base/WorkBase.ts:8](https://github.com/hpyer/node-easywechat/blob/a144a0f/src/Work/Base/WorkBase.ts#L8)
...
▸ **setAccessToken**(`accessToken`): [`default`](Work_Base_WorkBase.default.md)

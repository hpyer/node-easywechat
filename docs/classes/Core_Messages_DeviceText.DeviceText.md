[node-easywechat](../README.md) / [Exports](../modules.md) / [Core/Messages/DeviceText](../modules/Core_Messages_DeviceText.md) / DeviceText

# Class: DeviceText

[Core/Messages/DeviceText](../modules/Core_Messages_DeviceText.md).DeviceText
...
- [constructor](Core_Messages_DeviceText.DeviceText.md#constructor)

### Properties

- [attributes](Core_Messages_DeviceText.DeviceText.md#attributes)
- [from](Core_Messages_DeviceText.DeviceText.md#from)
- [id](Core_Messages_DeviceText.DeviceText.md#id)
- [jsonAliases](Core_Messages_DeviceText.DeviceText.md#jsonaliases)
- [properties](Core_Messages_DeviceText.DeviceText.md#properties)
- [required](Core_Messages_DeviceText.DeviceText.md#required)
- [to](Core_Messages_DeviceText.DeviceText.md#to)
- [type](Core_Messages_DeviceText.DeviceText.md#type)
- [ALL](Core_Messages_DeviceText.DeviceText.md#all)
- [DEVICE\_EVENT](Core_Messages_DeviceText.DeviceText.md#device_event)
- [DEVICE\_TEXT](Core_Messages_DeviceText.DeviceText.md#device_text)
- [EVENT](Core_Messages_DeviceText.DeviceText.md#event)
- [FILE](Core_Messages_DeviceText.DeviceText.md#file)
- [IMAGE](Core_Messages_DeviceText.DeviceText.md#image)
- [LINK](Core_Messages_DeviceText.DeviceText.md#link)
- [LOCATION](Core_Messages_DeviceText.DeviceText.md#location)
- [MARKDOWN](Core_Messages_DeviceText.DeviceText.md#markdown)
- [MINIPROGRAM\_NOTICE](Core_Messages_DeviceText.DeviceText.md#miniprogram_notice)
- [MINIPROGRAM\_PAGE](Core_Messages_DeviceText.DeviceText.md#miniprogram_page)
- [SHORT\_VIDEO](Core_Messages_DeviceText.DeviceText.md#short_video)
- [TEXT](Core_Messages_DeviceText.DeviceText.md#text)
- [TEXT\_CARD](Core_Messages_DeviceText.DeviceText.md#text_card)
- [TRANSFER](Core_Messages_DeviceText.DeviceText.md#transfer)
- [VIDEO](Core_Messages_DeviceText.DeviceText.md#video)
- [VOICE](Core_Messages_DeviceText.DeviceText.md#voice)

### Methods

- [all](Core_Messages_DeviceText.DeviceText.md#all)
- [checkRequiredAttributes](Core_Messages_DeviceText.DeviceText.md#checkrequiredattributes)
- [get](Core_Messages_DeviceText.DeviceText.md#get)
- [getAttribute](Core_Messages_DeviceText.DeviceText.md#getattribute)
- [getRequired](Core_Messages_DeviceText.DeviceText.md#getrequired)
- [getType](Core_Messages_DeviceText.DeviceText.md#gettype)
- [has](Core_Messages_DeviceText.DeviceText.md#has)
- [isRequired](Core_Messages_DeviceText.DeviceText.md#isrequired)
- [merge](Core_Messages_DeviceText.DeviceText.md#merge)
- [only](Core_Messages_DeviceText.DeviceText.md#only)
- [propertiesToObject](Core_Messages_DeviceText.DeviceText.md#propertiestoobject)
- [set](Core_Messages_DeviceText.DeviceText.md#set)
- [setAttribute](Core_Messages_DeviceText.DeviceText.md#setattribute)
- [setAttributes](Core_Messages_DeviceText.DeviceText.md#setattributes)
- [setType](Core_Messages_DeviceText.DeviceText.md#settype)
- [toXmlArray](Core_Messages_DeviceText.DeviceText.md#toxmlarray)
- [transformForJsonRequest](Core_Messages_DeviceText.DeviceText.md#transformforjsonrequest)
- [transformForJsonRequestWithoutType](Core_Messages_DeviceText.DeviceText.md#transformforjsonrequestwithouttype)
- [transformToXml](Core_Messages_DeviceText.DeviceText.md#transformtoxml)

## Constructors

### constructor

• **new DeviceText**(`attributes?`)
...
[Core/Messages/DeviceText.ts:9](https://github.com/hpyer/node-easywechat/blob/d6465cc/src/Core/Messages/DeviceText.ts#L9)
...
[Core/Messages/DeviceText.ts:8](https://github.com/hpyer/node-easywechat/blob/d6465cc/src/Core/Messages/DeviceText.ts#L8)
...
▸ **merge**(`attributes`): [`DeviceText`](Core_Messages_DeviceText.DeviceText.md)
...
▸ **set**(`name`, `value`): [`DeviceText`](Core_Messages_DeviceText.DeviceText.md)
...
▸ **setAttribute**(`name`, `value`): [`DeviceText`](Core_Messages_DeviceText.DeviceText.md)
...
▸ **setAttributes**(`attributes`): [`DeviceText`](Core_Messages_DeviceText.DeviceText.md)
...
[Core/Messages/DeviceText.ts:17](https://github.com/hpyer/node-easywechat/blob/d6465cc/src/Core/Messages/DeviceText.ts#L17)

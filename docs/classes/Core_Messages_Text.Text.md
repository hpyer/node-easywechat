[node-easywechat](../README.md) / [Exports](../modules.md) / [Core/Messages/Text](../modules/Core_Messages_Text.md) / Text

# Class: Text

[Core/Messages/Text](../modules/Core_Messages_Text.md).Text
...
- [constructor](Core_Messages_Text.Text.md#constructor)

### Properties

- [attributes](Core_Messages_Text.Text.md#attributes)
- [from](Core_Messages_Text.Text.md#from)
- [id](Core_Messages_Text.Text.md#id)
- [jsonAliases](Core_Messages_Text.Text.md#jsonaliases)
- [properties](Core_Messages_Text.Text.md#properties)
- [required](Core_Messages_Text.Text.md#required)
- [to](Core_Messages_Text.Text.md#to)
- [type](Core_Messages_Text.Text.md#type)
- [ALL](Core_Messages_Text.Text.md#all)
- [DEVICE\_EVENT](Core_Messages_Text.Text.md#device_event)
- [DEVICE\_TEXT](Core_Messages_Text.Text.md#device_text)
- [EVENT](Core_Messages_Text.Text.md#event)
- [FILE](Core_Messages_Text.Text.md#file)
- [IMAGE](Core_Messages_Text.Text.md#image)
- [LINK](Core_Messages_Text.Text.md#link)
- [LOCATION](Core_Messages_Text.Text.md#location)
- [MARKDOWN](Core_Messages_Text.Text.md#markdown)
- [MINIPROGRAM\_NOTICE](Core_Messages_Text.Text.md#miniprogram_notice)
- [MINIPROGRAM\_PAGE](Core_Messages_Text.Text.md#miniprogram_page)
- [SHORT\_VIDEO](Core_Messages_Text.Text.md#short_video)
- [TEXT](Core_Messages_Text.Text.md#text)
- [TEXT\_CARD](Core_Messages_Text.Text.md#text_card)
- [TRANSFER](Core_Messages_Text.Text.md#transfer)
- [VIDEO](Core_Messages_Text.Text.md#video)
- [VOICE](Core_Messages_Text.Text.md#voice)

### Methods

- [all](Core_Messages_Text.Text.md#all)
- [checkRequiredAttributes](Core_Messages_Text.Text.md#checkrequiredattributes)
- [get](Core_Messages_Text.Text.md#get)
- [getAttribute](Core_Messages_Text.Text.md#getattribute)
- [getRequired](Core_Messages_Text.Text.md#getrequired)
- [getType](Core_Messages_Text.Text.md#gettype)
- [has](Core_Messages_Text.Text.md#has)
- [isRequired](Core_Messages_Text.Text.md#isrequired)
- [merge](Core_Messages_Text.Text.md#merge)
- [only](Core_Messages_Text.Text.md#only)
- [propertiesToObject](Core_Messages_Text.Text.md#propertiestoobject)
- [set](Core_Messages_Text.Text.md#set)
- [setAttribute](Core_Messages_Text.Text.md#setattribute)
- [setAttributes](Core_Messages_Text.Text.md#setattributes)
- [setType](Core_Messages_Text.Text.md#settype)
- [toXmlArray](Core_Messages_Text.Text.md#toxmlarray)
- [transformForJsonRequest](Core_Messages_Text.Text.md#transformforjsonrequest)
- [transformForJsonRequestWithoutType](Core_Messages_Text.Text.md#transformforjsonrequestwithouttype)
- [transformToXml](Core_Messages_Text.Text.md#transformtoxml)
...
[Core/Messages/Text.ts:13](https://github.com/hpyer/node-easywechat/blob/b017670/src/Core/Messages/Text.ts#L13)
...
[Core/Messages/Text.ts:9](https://github.com/hpyer/node-easywechat/blob/b017670/src/Core/Messages/Text.ts#L9)
...
[Core/Messages/Text.ts:8](https://github.com/hpyer/node-easywechat/blob/b017670/src/Core/Messages/Text.ts#L8)
...
▸ **merge**(`attributes`): [`Text`](Core_Messages_Text.Text.md)
...
▸ **set**(`name`, `value`): [`Text`](Core_Messages_Text.Text.md)
...
▸ **setAttribute**(`name`, `value`): [`Text`](Core_Messages_Text.Text.md)
...
▸ **setAttributes**(`attributes`): [`Text`](Core_Messages_Text.Text.md)
...
[Core/Messages/Text.ts:18](https://github.com/hpyer/node-easywechat/blob/b017670/src/Core/Messages/Text.ts#L18)

[node-easywechat](../README.md) / [Exports](../modules.md) / [Core/Messages/Music](../modules/Core_Messages_Music.md) / Music

# Class: Music

[Core/Messages/Music](../modules/Core_Messages_Music.md).Music
...
- [constructor](Core_Messages_Music.Music.md#constructor)

### Properties

- [attributes](Core_Messages_Music.Music.md#attributes)
- [from](Core_Messages_Music.Music.md#from)
- [id](Core_Messages_Music.Music.md#id)
- [jsonAliases](Core_Messages_Music.Music.md#jsonaliases)
- [properties](Core_Messages_Music.Music.md#properties)
- [required](Core_Messages_Music.Music.md#required)
- [to](Core_Messages_Music.Music.md#to)
- [type](Core_Messages_Music.Music.md#type)
- [ALL](Core_Messages_Music.Music.md#all)
- [DEVICE\_EVENT](Core_Messages_Music.Music.md#device_event)
- [DEVICE\_TEXT](Core_Messages_Music.Music.md#device_text)
- [EVENT](Core_Messages_Music.Music.md#event)
- [FILE](Core_Messages_Music.Music.md#file)
- [IMAGE](Core_Messages_Music.Music.md#image)
- [LINK](Core_Messages_Music.Music.md#link)
- [LOCATION](Core_Messages_Music.Music.md#location)
- [MARKDOWN](Core_Messages_Music.Music.md#markdown)
- [MINIPROGRAM\_NOTICE](Core_Messages_Music.Music.md#miniprogram_notice)
- [MINIPROGRAM\_PAGE](Core_Messages_Music.Music.md#miniprogram_page)
- [SHORT\_VIDEO](Core_Messages_Music.Music.md#short_video)
- [TEXT](Core_Messages_Music.Music.md#text)
- [TEXT\_CARD](Core_Messages_Music.Music.md#text_card)
- [TRANSFER](Core_Messages_Music.Music.md#transfer)
- [VIDEO](Core_Messages_Music.Music.md#video)
- [VOICE](Core_Messages_Music.Music.md#voice)

### Methods

- [all](Core_Messages_Music.Music.md#all)
- [checkRequiredAttributes](Core_Messages_Music.Music.md#checkrequiredattributes)
- [get](Core_Messages_Music.Music.md#get)
- [getAttribute](Core_Messages_Music.Music.md#getattribute)
- [getRequired](Core_Messages_Music.Music.md#getrequired)
- [getType](Core_Messages_Music.Music.md#gettype)
- [has](Core_Messages_Music.Music.md#has)
- [isRequired](Core_Messages_Music.Music.md#isrequired)
- [merge](Core_Messages_Music.Music.md#merge)
- [only](Core_Messages_Music.Music.md#only)
- [propertiesToObject](Core_Messages_Music.Music.md#propertiestoobject)
- [set](Core_Messages_Music.Music.md#set)
- [setAttribute](Core_Messages_Music.Music.md#setattribute)
- [setAttributes](Core_Messages_Music.Music.md#setattributes)
- [setType](Core_Messages_Music.Music.md#settype)
- [toXmlArray](Core_Messages_Music.Music.md#toxmlarray)
- [transformForJsonRequest](Core_Messages_Music.Music.md#transformforjsonrequest)
- [transformForJsonRequestWithoutType](Core_Messages_Music.Music.md#transformforjsonrequestwithouttype)
- [transformToXml](Core_Messages_Music.Music.md#transformtoxml)

## Constructors

### constructor

• **new Music**(`attributes?`)
...
[Core/Messages/Music.ts:17](https://github.com/hpyer/node-easywechat/blob/e4961d7/src/Core/Messages/Music.ts#L17)
...
[Core/Messages/Music.ts:9](https://github.com/hpyer/node-easywechat/blob/e4961d7/src/Core/Messages/Music.ts#L9)
...
[Core/Messages/Music.ts:8](https://github.com/hpyer/node-easywechat/blob/e4961d7/src/Core/Messages/Music.ts#L8)
...
▸ **merge**(`attributes`): [`Music`](Core_Messages_Music.Music.md)
...
▸ **set**(`name`, `value`): [`Music`](Core_Messages_Music.Music.md)
...
▸ **setAttribute**(`name`, `value`): [`Music`](Core_Messages_Music.Music.md)
...
▸ **setAttributes**(`attributes`): [`Music`](Core_Messages_Music.Music.md)
...
[Core/Messages/Music.ts:22](https://github.com/hpyer/node-easywechat/blob/e4961d7/src/Core/Messages/Music.ts#L22)

[node-easywechat](../README.md) / [Exports](../modules.md) / [Core/Messages/InteractiveTaskCard](../modules/Core_Messages_InteractiveTaskCard.md) / InteractiveTaskCard
...
[Core/Messages/InteractiveTaskCard.ts:12](https://github.com/hpyer/node-easywechat/blob/3eacadb/src/Core/Messages/InteractiveTaskCard.ts#L12)
...
[Core/Messages/InteractiveTaskCard.ts:11](https://github.com/hpyer/node-easywechat/blob/3eacadb/src/Core/Messages/InteractiveTaskCard.ts#L11)

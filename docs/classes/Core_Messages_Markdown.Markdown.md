[node-easywechat](../README.md) / [Exports](../modules.md) / [Core/Messages/Markdown](../modules/Core_Messages_Markdown.md) / Markdown

# Class: Markdown

[Core/Messages/Markdown](../modules/Core_Messages_Markdown.md).Markdown
...
- [constructor](Core_Messages_Markdown.Markdown.md#constructor)

### Properties

- [attributes](Core_Messages_Markdown.Markdown.md#attributes)
- [from](Core_Messages_Markdown.Markdown.md#from)
- [id](Core_Messages_Markdown.Markdown.md#id)
- [jsonAliases](Core_Messages_Markdown.Markdown.md#jsonaliases)
- [properties](Core_Messages_Markdown.Markdown.md#properties)
- [required](Core_Messages_Markdown.Markdown.md#required)
- [to](Core_Messages_Markdown.Markdown.md#to)
- [type](Core_Messages_Markdown.Markdown.md#type)
- [ALL](Core_Messages_Markdown.Markdown.md#all)
- [DEVICE\_EVENT](Core_Messages_Markdown.Markdown.md#device_event)
- [DEVICE\_TEXT](Core_Messages_Markdown.Markdown.md#device_text)
- [EVENT](Core_Messages_Markdown.Markdown.md#event)
- [FILE](Core_Messages_Markdown.Markdown.md#file)
- [IMAGE](Core_Messages_Markdown.Markdown.md#image)
- [LINK](Core_Messages_Markdown.Markdown.md#link)
- [LOCATION](Core_Messages_Markdown.Markdown.md#location)
- [MARKDOWN](Core_Messages_Markdown.Markdown.md#markdown)
- [MINIPROGRAM\_NOTICE](Core_Messages_Markdown.Markdown.md#miniprogram_notice)
- [MINIPROGRAM\_PAGE](Core_Messages_Markdown.Markdown.md#miniprogram_page)
- [SHORT\_VIDEO](Core_Messages_Markdown.Markdown.md#short_video)
- [TEXT](Core_Messages_Markdown.Markdown.md#text)
- [TEXT\_CARD](Core_Messages_Markdown.Markdown.md#text_card)
- [TRANSFER](Core_Messages_Markdown.Markdown.md#transfer)
- [VIDEO](Core_Messages_Markdown.Markdown.md#video)
- [VOICE](Core_Messages_Markdown.Markdown.md#voice)

### Methods

- [all](Core_Messages_Markdown.Markdown.md#all)
- [checkRequiredAttributes](Core_Messages_Markdown.Markdown.md#checkrequiredattributes)
- [get](Core_Messages_Markdown.Markdown.md#get)
- [getAttribute](Core_Messages_Markdown.Markdown.md#getattribute)
- [getRequired](Core_Messages_Markdown.Markdown.md#getrequired)
- [getType](Core_Messages_Markdown.Markdown.md#gettype)
- [has](Core_Messages_Markdown.Markdown.md#has)
- [isRequired](Core_Messages_Markdown.Markdown.md#isrequired)
- [merge](Core_Messages_Markdown.Markdown.md#merge)
- [only](Core_Messages_Markdown.Markdown.md#only)
- [propertiesToObject](Core_Messages_Markdown.Markdown.md#propertiestoobject)
- [set](Core_Messages_Markdown.Markdown.md#set)
- [setAttribute](Core_Messages_Markdown.Markdown.md#setattribute)
- [setAttributes](Core_Messages_Markdown.Markdown.md#setattributes)
- [setType](Core_Messages_Markdown.Markdown.md#settype)
- [toXmlArray](Core_Messages_Markdown.Markdown.md#toxmlarray)
- [transformForJsonRequest](Core_Messages_Markdown.Markdown.md#transformforjsonrequest)
- [transformForJsonRequestWithoutType](Core_Messages_Markdown.Markdown.md#transformforjsonrequestwithouttype)
- [transformToXml](Core_Messages_Markdown.Markdown.md#transformtoxml)

## Constructors

### constructor

• **new Markdown**(`attributes?`)
...
[Core/Messages/Markdown.ts:9](https://github.com/hpyer/node-easywechat/blob/a144a0f/src/Core/Messages/Markdown.ts#L9)
...
[Core/Messages/Markdown.ts:8](https://github.com/hpyer/node-easywechat/blob/a144a0f/src/Core/Messages/Markdown.ts#L8)
...
▸ **merge**(`attributes`): [`Markdown`](Core_Messages_Markdown.Markdown.md)
...
▸ **set**(`name`, `value`): [`Markdown`](Core_Messages_Markdown.Markdown.md)
...
▸ **setAttribute**(`name`, `value`): [`Markdown`](Core_Messages_Markdown.Markdown.md)
...
▸ **setAttributes**(`attributes`): [`Markdown`](Core_Messages_Markdown.Markdown.md)

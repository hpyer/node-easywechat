[node-easywechat](../README.md) / [Exports](../modules.md) / [Core/Messages/Image](../modules/Core_Messages_Image.md) / Image

# Class: Image

[Core/Messages/Image](../modules/Core_Messages_Image.md).Image
...
- [constructor](Core_Messages_Image.Image.md#constructor)

### Properties

- [attributes](Core_Messages_Image.Image.md#attributes)
- [from](Core_Messages_Image.Image.md#from)
- [id](Core_Messages_Image.Image.md#id)
- [jsonAliases](Core_Messages_Image.Image.md#jsonaliases)
- [properties](Core_Messages_Image.Image.md#properties)
- [required](Core_Messages_Image.Image.md#required)
- [to](Core_Messages_Image.Image.md#to)
- [type](Core_Messages_Image.Image.md#type)
- [ALL](Core_Messages_Image.Image.md#all)
- [DEVICE\_EVENT](Core_Messages_Image.Image.md#device_event)
- [DEVICE\_TEXT](Core_Messages_Image.Image.md#device_text)
- [EVENT](Core_Messages_Image.Image.md#event)
- [FILE](Core_Messages_Image.Image.md#file)
- [IMAGE](Core_Messages_Image.Image.md#image)
- [LINK](Core_Messages_Image.Image.md#link)
- [LOCATION](Core_Messages_Image.Image.md#location)
- [MARKDOWN](Core_Messages_Image.Image.md#markdown)
- [MINIPROGRAM\_NOTICE](Core_Messages_Image.Image.md#miniprogram_notice)
- [MINIPROGRAM\_PAGE](Core_Messages_Image.Image.md#miniprogram_page)
- [SHORT\_VIDEO](Core_Messages_Image.Image.md#short_video)
- [TEXT](Core_Messages_Image.Image.md#text)
- [TEXT\_CARD](Core_Messages_Image.Image.md#text_card)
- [TRANSFER](Core_Messages_Image.Image.md#transfer)
- [VIDEO](Core_Messages_Image.Image.md#video)
- [VOICE](Core_Messages_Image.Image.md#voice)

### Methods

- [all](Core_Messages_Image.Image.md#all)
- [checkRequiredAttributes](Core_Messages_Image.Image.md#checkrequiredattributes)
- [get](Core_Messages_Image.Image.md#get)
- [getAttribute](Core_Messages_Image.Image.md#getattribute)
- [getMediaId](Core_Messages_Image.Image.md#getmediaid)
- [getRequired](Core_Messages_Image.Image.md#getrequired)
- [getType](Core_Messages_Image.Image.md#gettype)
- [has](Core_Messages_Image.Image.md#has)
- [isRequired](Core_Messages_Image.Image.md#isrequired)
- [merge](Core_Messages_Image.Image.md#merge)
- [only](Core_Messages_Image.Image.md#only)
- [propertiesToObject](Core_Messages_Image.Image.md#propertiestoobject)
- [set](Core_Messages_Image.Image.md#set)
- [setAttribute](Core_Messages_Image.Image.md#setattribute)
- [setAttributes](Core_Messages_Image.Image.md#setattributes)
- [setType](Core_Messages_Image.Image.md#settype)
- [toXmlArray](Core_Messages_Image.Image.md#toxmlarray)
- [transformForJsonRequest](Core_Messages_Image.Image.md#transformforjsonrequest)
- [transformForJsonRequestWithoutType](Core_Messages_Image.Image.md#transformforjsonrequestwithouttype)
- [transformToXml](Core_Messages_Image.Image.md#transformtoxml)

## Constructors

### constructor

• **new Image**(`mediaId`, `type?`, `attributes?`)
...
[Core/Messages/Media.ts:9](https://github.com/hpyer/node-easywechat/blob/d6465cc/src/Core/Messages/Media.ts#L9)
...
[Core/Messages/Image.ts:8](https://github.com/hpyer/node-easywechat/blob/d6465cc/src/Core/Messages/Image.ts#L8)
...
▸ **merge**(`attributes`): [`Image`](Core_Messages_Image.Image.md)
...
▸ **set**(`name`, `value`): [`Image`](Core_Messages_Image.Image.md)
...
▸ **setAttribute**(`name`, `value`): [`Image`](Core_Messages_Image.Image.md)
...
▸ **setAttributes**(`attributes`): [`Image`](Core_Messages_Image.Image.md)

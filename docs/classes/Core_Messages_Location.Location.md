[node-easywechat](../README.md) / [Exports](../modules.md) / [Core/Messages/Location](../modules/Core_Messages_Location.md) / Location

# Class: Location

[Core/Messages/Location](../modules/Core_Messages_Location.md).Location
...
- [constructor](Core_Messages_Location.Location.md#constructor)

### Properties

- [attributes](Core_Messages_Location.Location.md#attributes)
- [from](Core_Messages_Location.Location.md#from)
- [id](Core_Messages_Location.Location.md#id)
- [jsonAliases](Core_Messages_Location.Location.md#jsonaliases)
- [properties](Core_Messages_Location.Location.md#properties)
- [required](Core_Messages_Location.Location.md#required)
- [to](Core_Messages_Location.Location.md#to)
- [type](Core_Messages_Location.Location.md#type)
- [ALL](Core_Messages_Location.Location.md#all)
- [DEVICE\_EVENT](Core_Messages_Location.Location.md#device_event)
- [DEVICE\_TEXT](Core_Messages_Location.Location.md#device_text)
- [EVENT](Core_Messages_Location.Location.md#event)
- [FILE](Core_Messages_Location.Location.md#file)
- [IMAGE](Core_Messages_Location.Location.md#image)
- [LINK](Core_Messages_Location.Location.md#link)
- [LOCATION](Core_Messages_Location.Location.md#location)
- [MARKDOWN](Core_Messages_Location.Location.md#markdown)
- [MINIPROGRAM\_NOTICE](Core_Messages_Location.Location.md#miniprogram_notice)
- [MINIPROGRAM\_PAGE](Core_Messages_Location.Location.md#miniprogram_page)
- [SHORT\_VIDEO](Core_Messages_Location.Location.md#short_video)
- [TEXT](Core_Messages_Location.Location.md#text)
- [TEXT\_CARD](Core_Messages_Location.Location.md#text_card)
- [TRANSFER](Core_Messages_Location.Location.md#transfer)
- [VIDEO](Core_Messages_Location.Location.md#video)
- [VOICE](Core_Messages_Location.Location.md#voice)

### Methods

- [all](Core_Messages_Location.Location.md#all)
- [checkRequiredAttributes](Core_Messages_Location.Location.md#checkrequiredattributes)
- [get](Core_Messages_Location.Location.md#get)
- [getAttribute](Core_Messages_Location.Location.md#getattribute)
- [getRequired](Core_Messages_Location.Location.md#getrequired)
- [getType](Core_Messages_Location.Location.md#gettype)
- [has](Core_Messages_Location.Location.md#has)
- [isRequired](Core_Messages_Location.Location.md#isrequired)
- [merge](Core_Messages_Location.Location.md#merge)
- [only](Core_Messages_Location.Location.md#only)
- [propertiesToObject](Core_Messages_Location.Location.md#propertiestoobject)
- [set](Core_Messages_Location.Location.md#set)
- [setAttribute](Core_Messages_Location.Location.md#setattribute)
- [setAttributes](Core_Messages_Location.Location.md#setattributes)
- [setType](Core_Messages_Location.Location.md#settype)
- [toXmlArray](Core_Messages_Location.Location.md#toxmlarray)
- [transformForJsonRequest](Core_Messages_Location.Location.md#transformforjsonrequest)
- [transformForJsonRequestWithoutType](Core_Messages_Location.Location.md#transformforjsonrequestwithouttype)
- [transformToXml](Core_Messages_Location.Location.md#transformtoxml)
...
[Core/Messages/Location.ts:9](https://github.com/hpyer/node-easywechat/blob/a144a0f/src/Core/Messages/Location.ts#L9)
...
[Core/Messages/Location.ts:8](https://github.com/hpyer/node-easywechat/blob/a144a0f/src/Core/Messages/Location.ts#L8)
...
▸ **merge**(`attributes`): [`Location`](Core_Messages_Location.Location.md)
...
▸ **set**(`name`, `value`): [`Location`](Core_Messages_Location.Location.md)
...
▸ **setAttribute**(`name`, `value`): [`Location`](Core_Messages_Location.Location.md)
...
▸ **setAttributes**(`attributes`): [`Location`](Core_Messages_Location.Location.md)

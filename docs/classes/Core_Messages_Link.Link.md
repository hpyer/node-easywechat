[node-easywechat](../README.md) / [Exports](../modules.md) / [Core/Messages/Link](../modules/Core_Messages_Link.md) / Link

# Class: Link

[Core/Messages/Link](../modules/Core_Messages_Link.md).Link
...
- [constructor](Core_Messages_Link.Link.md#constructor)

### Properties

- [attributes](Core_Messages_Link.Link.md#attributes)
- [from](Core_Messages_Link.Link.md#from)
- [id](Core_Messages_Link.Link.md#id)
- [jsonAliases](Core_Messages_Link.Link.md#jsonaliases)
- [properties](Core_Messages_Link.Link.md#properties)
- [required](Core_Messages_Link.Link.md#required)
- [to](Core_Messages_Link.Link.md#to)
- [type](Core_Messages_Link.Link.md#type)
- [ALL](Core_Messages_Link.Link.md#all)
- [DEVICE\_EVENT](Core_Messages_Link.Link.md#device_event)
- [DEVICE\_TEXT](Core_Messages_Link.Link.md#device_text)
- [EVENT](Core_Messages_Link.Link.md#event)
- [FILE](Core_Messages_Link.Link.md#file)
- [IMAGE](Core_Messages_Link.Link.md#image)
- [LINK](Core_Messages_Link.Link.md#link)
- [LOCATION](Core_Messages_Link.Link.md#location)
- [MARKDOWN](Core_Messages_Link.Link.md#markdown)
- [MINIPROGRAM\_NOTICE](Core_Messages_Link.Link.md#miniprogram_notice)
- [MINIPROGRAM\_PAGE](Core_Messages_Link.Link.md#miniprogram_page)
- [SHORT\_VIDEO](Core_Messages_Link.Link.md#short_video)
- [TEXT](Core_Messages_Link.Link.md#text)
- [TEXT\_CARD](Core_Messages_Link.Link.md#text_card)
- [TRANSFER](Core_Messages_Link.Link.md#transfer)
- [VIDEO](Core_Messages_Link.Link.md#video)
- [VOICE](Core_Messages_Link.Link.md#voice)

### Methods

- [all](Core_Messages_Link.Link.md#all)
- [checkRequiredAttributes](Core_Messages_Link.Link.md#checkrequiredattributes)
- [get](Core_Messages_Link.Link.md#get)
- [getAttribute](Core_Messages_Link.Link.md#getattribute)
- [getRequired](Core_Messages_Link.Link.md#getrequired)
- [getType](Core_Messages_Link.Link.md#gettype)
- [has](Core_Messages_Link.Link.md#has)
- [isRequired](Core_Messages_Link.Link.md#isrequired)
- [merge](Core_Messages_Link.Link.md#merge)
- [only](Core_Messages_Link.Link.md#only)
- [propertiesToObject](Core_Messages_Link.Link.md#propertiestoobject)
- [set](Core_Messages_Link.Link.md#set)
- [setAttribute](Core_Messages_Link.Link.md#setattribute)
- [setAttributes](Core_Messages_Link.Link.md#setattributes)
- [setType](Core_Messages_Link.Link.md#settype)
- [toXmlArray](Core_Messages_Link.Link.md#toxmlarray)
- [transformForJsonRequest](Core_Messages_Link.Link.md#transformforjsonrequest)
- [transformForJsonRequestWithoutType](Core_Messages_Link.Link.md#transformforjsonrequestwithouttype)
- [transformToXml](Core_Messages_Link.Link.md#transformtoxml)
...
[Core/Messages/Link.ts:9](https://github.com/hpyer/node-easywechat/blob/3eacadb/src/Core/Messages/Link.ts#L9)
...
[Core/Messages/Link.ts:8](https://github.com/hpyer/node-easywechat/blob/3eacadb/src/Core/Messages/Link.ts#L8)
...
▸ **merge**(`attributes`): [`Link`](Core_Messages_Link.Link.md)
...
▸ **set**(`name`, `value`): [`Link`](Core_Messages_Link.Link.md)
...
▸ **setAttribute**(`name`, `value`): [`Link`](Core_Messages_Link.Link.md)
...
▸ **setAttributes**(`attributes`): [`Link`](Core_Messages_Link.Link.md)

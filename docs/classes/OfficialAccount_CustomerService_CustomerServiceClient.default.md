...
[OfficialAccount/CustomerService/CustomerServiceClient.ts:70](https://github.com/hpyer/node-easywechat/blob/3eacadb/src/OfficialAccount/CustomerService/CustomerServiceClient.ts#L70)

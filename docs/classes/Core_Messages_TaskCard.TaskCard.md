[node-easywechat](../README.md) / [Exports](../modules.md) / [Core/Messages/TaskCard](../modules/Core_Messages_TaskCard.md) / TaskCard

# Class: TaskCard

[Core/Messages/TaskCard](../modules/Core_Messages_TaskCard.md).TaskCard
...
- [constructor](Core_Messages_TaskCard.TaskCard.md#constructor)

### Properties

- [attributes](Core_Messages_TaskCard.TaskCard.md#attributes)
- [from](Core_Messages_TaskCard.TaskCard.md#from)
- [id](Core_Messages_TaskCard.TaskCard.md#id)
- [jsonAliases](Core_Messages_TaskCard.TaskCard.md#jsonaliases)
- [properties](Core_Messages_TaskCard.TaskCard.md#properties)
- [required](Core_Messages_TaskCard.TaskCard.md#required)
- [to](Core_Messages_TaskCard.TaskCard.md#to)
- [type](Core_Messages_TaskCard.TaskCard.md#type)
- [ALL](Core_Messages_TaskCard.TaskCard.md#all)
- [DEVICE\_EVENT](Core_Messages_TaskCard.TaskCard.md#device_event)
- [DEVICE\_TEXT](Core_Messages_TaskCard.TaskCard.md#device_text)
- [EVENT](Core_Messages_TaskCard.TaskCard.md#event)
- [FILE](Core_Messages_TaskCard.TaskCard.md#file)
- [IMAGE](Core_Messages_TaskCard.TaskCard.md#image)
- [LINK](Core_Messages_TaskCard.TaskCard.md#link)
- [LOCATION](Core_Messages_TaskCard.TaskCard.md#location)
- [MARKDOWN](Core_Messages_TaskCard.TaskCard.md#markdown)
- [MINIPROGRAM\_NOTICE](Core_Messages_TaskCard.TaskCard.md#miniprogram_notice)
- [MINIPROGRAM\_PAGE](Core_Messages_TaskCard.TaskCard.md#miniprogram_page)
- [SHORT\_VIDEO](Core_Messages_TaskCard.TaskCard.md#short_video)
- [TEXT](Core_Messages_TaskCard.TaskCard.md#text)
- [TEXT\_CARD](Core_Messages_TaskCard.TaskCard.md#text_card)
- [TRANSFER](Core_Messages_TaskCard.TaskCard.md#transfer)
- [VIDEO](Core_Messages_TaskCard.TaskCard.md#video)
- [VOICE](Core_Messages_TaskCard.TaskCard.md#voice)

### Methods

- [all](Core_Messages_TaskCard.TaskCard.md#all)
- [checkRequiredAttributes](Core_Messages_TaskCard.TaskCard.md#checkrequiredattributes)
- [get](Core_Messages_TaskCard.TaskCard.md#get)
- [getAttribute](Core_Messages_TaskCard.TaskCard.md#getattribute)
- [getRequired](Core_Messages_TaskCard.TaskCard.md#getrequired)
- [getType](Core_Messages_TaskCard.TaskCard.md#gettype)
- [has](Core_Messages_TaskCard.TaskCard.md#has)
- [isRequired](Core_Messages_TaskCard.TaskCard.md#isrequired)
- [merge](Core_Messages_TaskCard.TaskCard.md#merge)
- [only](Core_Messages_TaskCard.TaskCard.md#only)
- [propertiesToObject](Core_Messages_TaskCard.TaskCard.md#propertiestoobject)
- [set](Core_Messages_TaskCard.TaskCard.md#set)
- [setAttribute](Core_Messages_TaskCard.TaskCard.md#setattribute)
- [setAttributes](Core_Messages_TaskCard.TaskCard.md#setattributes)
- [setType](Core_Messages_TaskCard.TaskCard.md#settype)
- [toXmlArray](Core_Messages_TaskCard.TaskCard.md#toxmlarray)
- [transformForJsonRequest](Core_Messages_TaskCard.TaskCard.md#transformforjsonrequest)
- [transformForJsonRequestWithoutType](Core_Messages_TaskCard.TaskCard.md#transformforjsonrequestwithouttype)
- [transformToXml](Core_Messages_TaskCard.TaskCard.md#transformtoxml)

## Constructors

### constructor

• **new TaskCard**(`attributes?`)
...
[Core/Messages/TaskCard.ts:9](https://github.com/hpyer/node-easywechat/blob/a144a0f/src/Core/Messages/TaskCard.ts#L9)
...
[Core/Messages/TaskCard.ts:8](https://github.com/hpyer/node-easywechat/blob/a144a0f/src/Core/Messages/TaskCard.ts#L8)
...
▸ **merge**(`attributes`): [`TaskCard`](Core_Messages_TaskCard.TaskCard.md)
...
▸ **set**(`name`, `value`): [`TaskCard`](Core_Messages_TaskCard.TaskCard.md)
...
▸ **setAttribute**(`name`, `value`): [`TaskCard`](Core_Messages_TaskCard.TaskCard.md)
...
▸ **setAttributes**(`attributes`): [`TaskCard`](Core_Messages_TaskCard.TaskCard.md)

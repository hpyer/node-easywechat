[node-easywechat](../README.md) / [Exports](../modules.md) / [MiniProgram/Auth/AuthClient](../modules/MiniProgram_Auth_AuthClient.md) / default

# Class: default

[MiniProgram/Auth/AuthClient](../modules/MiniProgram_Auth_AuthClient.md).default
...
- [constructor](MiniProgram_Auth_AuthClient.default.md#constructor)

### Properties

- [accessToken](MiniProgram_Auth_AuthClient.default.md#accesstoken)
- [app](MiniProgram_Auth_AuthClient.default.md#app)

### Methods

- [doRequest](MiniProgram_Auth_AuthClient.default.md#dorequest)
- [getAccessToken](MiniProgram_Auth_AuthClient.default.md#getaccesstoken)
- [httpGet](MiniProgram_Auth_AuthClient.default.md#httpget)
- [httpPost](MiniProgram_Auth_AuthClient.default.md#httppost)
- [httpPostJson](MiniProgram_Auth_AuthClient.default.md#httppostjson)
- [httpUpload](MiniProgram_Auth_AuthClient.default.md#httpupload)
- [request](MiniProgram_Auth_AuthClient.default.md#request)
- [requestRaw](MiniProgram_Auth_AuthClient.default.md#requestraw)
- [session](MiniProgram_Auth_AuthClient.default.md#session)
- [setAccessToken](MiniProgram_Auth_AuthClient.default.md#setaccesstoken)
...
| :------ | :------ | :------ |
| `code` | `string` | 小程序端通过 wx.login 获取 |
...
[MiniProgram/Auth/AuthClient.ts:12](https://github.com/hpyer/node-easywechat/blob/a144a0f/src/MiniProgram/Auth/AuthClient.ts#L12)

___

### setAccessToken

▸ **setAccessToken**(`accessToken`): [`default`](MiniProgram_Auth_AuthClient.default.md)

[node-easywechat](../README.md) / [Exports](../modules.md) / [Core/Messages/TextCard](../modules/Core_Messages_TextCard.md) / TextCard

# Class: TextCard

[Core/Messages/TextCard](../modules/Core_Messages_TextCard.md).TextCard
...
- [constructor](Core_Messages_TextCard.TextCard.md#constructor)

### Properties

- [attributes](Core_Messages_TextCard.TextCard.md#attributes)
- [from](Core_Messages_TextCard.TextCard.md#from)
- [id](Core_Messages_TextCard.TextCard.md#id)
- [jsonAliases](Core_Messages_TextCard.TextCard.md#jsonaliases)
- [properties](Core_Messages_TextCard.TextCard.md#properties)
- [required](Core_Messages_TextCard.TextCard.md#required)
- [to](Core_Messages_TextCard.TextCard.md#to)
- [type](Core_Messages_TextCard.TextCard.md#type)
- [ALL](Core_Messages_TextCard.TextCard.md#all)
- [DEVICE\_EVENT](Core_Messages_TextCard.TextCard.md#device_event)
- [DEVICE\_TEXT](Core_Messages_TextCard.TextCard.md#device_text)
- [EVENT](Core_Messages_TextCard.TextCard.md#event)
- [FILE](Core_Messages_TextCard.TextCard.md#file)
- [IMAGE](Core_Messages_TextCard.TextCard.md#image)
- [LINK](Core_Messages_TextCard.TextCard.md#link)
- [LOCATION](Core_Messages_TextCard.TextCard.md#location)
- [MARKDOWN](Core_Messages_TextCard.TextCard.md#markdown)
- [MINIPROGRAM\_NOTICE](Core_Messages_TextCard.TextCard.md#miniprogram_notice)
- [MINIPROGRAM\_PAGE](Core_Messages_TextCard.TextCard.md#miniprogram_page)
- [SHORT\_VIDEO](Core_Messages_TextCard.TextCard.md#short_video)
- [TEXT](Core_Messages_TextCard.TextCard.md#text)
- [TEXT\_CARD](Core_Messages_TextCard.TextCard.md#text_card)
- [TRANSFER](Core_Messages_TextCard.TextCard.md#transfer)
- [VIDEO](Core_Messages_TextCard.TextCard.md#video)
- [VOICE](Core_Messages_TextCard.TextCard.md#voice)

### Methods

- [all](Core_Messages_TextCard.TextCard.md#all)
- [checkRequiredAttributes](Core_Messages_TextCard.TextCard.md#checkrequiredattributes)
- [get](Core_Messages_TextCard.TextCard.md#get)
- [getAttribute](Core_Messages_TextCard.TextCard.md#getattribute)
- [getRequired](Core_Messages_TextCard.TextCard.md#getrequired)
- [getType](Core_Messages_TextCard.TextCard.md#gettype)
- [has](Core_Messages_TextCard.TextCard.md#has)
- [isRequired](Core_Messages_TextCard.TextCard.md#isrequired)
- [merge](Core_Messages_TextCard.TextCard.md#merge)
- [only](Core_Messages_TextCard.TextCard.md#only)
- [propertiesToObject](Core_Messages_TextCard.TextCard.md#propertiestoobject)
- [set](Core_Messages_TextCard.TextCard.md#set)
- [setAttribute](Core_Messages_TextCard.TextCard.md#setattribute)
- [setAttributes](Core_Messages_TextCard.TextCard.md#setattributes)
- [setType](Core_Messages_TextCard.TextCard.md#settype)
- [toXmlArray](Core_Messages_TextCard.TextCard.md#toxmlarray)
- [transformForJsonRequest](Core_Messages_TextCard.TextCard.md#transformforjsonrequest)
- [transformForJsonRequestWithoutType](Core_Messages_TextCard.TextCard.md#transformforjsonrequestwithouttype)
- [transformToXml](Core_Messages_TextCard.TextCard.md#transformtoxml)

## Constructors

### constructor

• **new TextCard**(`attributes?`)
...
[Core/Messages/TextCard.ts:9](https://github.com/hpyer/node-easywechat/blob/a144a0f/src/Core/Messages/TextCard.ts#L9)
...
[Core/Messages/TextCard.ts:8](https://github.com/hpyer/node-easywechat/blob/a144a0f/src/Core/Messages/TextCard.ts#L8)
...
▸ **merge**(`attributes`): [`TextCard`](Core_Messages_TextCard.TextCard.md)
...
▸ **set**(`name`, `value`): [`TextCard`](Core_Messages_TextCard.TextCard.md)
...
▸ **setAttribute**(`name`, `value`): [`TextCard`](Core_Messages_TextCard.TextCard.md)
...
▸ **setAttributes**(`attributes`): [`TextCard`](Core_Messages_TextCard.TextCard.md)

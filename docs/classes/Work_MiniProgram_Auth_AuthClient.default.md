[node-easywechat](../README.md) / [Exports](../modules.md) / [Work/MiniProgram/Auth/AuthClient](../modules/Work_MiniProgram_Auth_AuthClient.md) / default

# Class: default

[Work/MiniProgram/Auth/AuthClient](../modules/Work_MiniProgram_Auth_AuthClient.md).default
...
- [constructor](Work_MiniProgram_Auth_AuthClient.default.md#constructor)

### Properties

- [accessToken](Work_MiniProgram_Auth_AuthClient.default.md#accesstoken)
- [app](Work_MiniProgram_Auth_AuthClient.default.md#app)

### Methods

- [doRequest](Work_MiniProgram_Auth_AuthClient.default.md#dorequest)
- [getAccessToken](Work_MiniProgram_Auth_AuthClient.default.md#getaccesstoken)
- [httpGet](Work_MiniProgram_Auth_AuthClient.default.md#httpget)
- [httpPost](Work_MiniProgram_Auth_AuthClient.default.md#httppost)
- [httpPostJson](Work_MiniProgram_Auth_AuthClient.default.md#httppostjson)
- [httpUpload](Work_MiniProgram_Auth_AuthClient.default.md#httpupload)
- [request](Work_MiniProgram_Auth_AuthClient.default.md#request)
- [requestRaw](Work_MiniProgram_Auth_AuthClient.default.md#requestraw)
- [session](Work_MiniProgram_Auth_AuthClient.default.md#session)
- [setAccessToken](Work_MiniProgram_Auth_AuthClient.default.md#setaccesstoken)
...
[Work/MiniProgram/Auth/AuthClient.ts:12](https://github.com/hpyer/node-easywechat/blob/e4961d7/src/Work/MiniProgram/Auth/AuthClient.ts#L12)

___

### setAccessToken

▸ **setAccessToken**(`accessToken`): [`default`](Work_MiniProgram_Auth_AuthClient.default.md)
